...
in rec {
  ...
  catppuccin = mkTmuxPlugin {
    ...
    src = fetchFromGitHub {
      owner = "catppuccin";
      repo = "tmux";
      rev = "893917360d667645908753b982edd1624dc57cd6";
      hash = "sha256-IkyBAQkr47PP4QeL64Ha4HPQPqSG5uJCPTlqCduVT5M=";
    };
    postInstall = ''
  ...
  extrakto = mkTmuxPlugin {
    ...
    postInstall = ''
    for f in scripts/extrakto.sh scripts/helpers.sh scripts/open.sh; do
      chmod +x $target/$f
