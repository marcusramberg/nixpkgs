...
in
{
  options = {
    services.grafana-kiosk = {
      ...
      user = mkOption {
        ...
        description = ''
          User account under which grafana-kiosk runs.
        '';
      };
      ...
      group = mkOption {
        ...
        default = "grafana-kiosk";
        description = ''
          Group under which grafana-kiosk runs.
        '';
      };
    };
  };
  ...
  config = mkIf cfg.enable {
    systemd.tmpfiles.settings."10-grafana-kiosk".${cfg.dataDir}.d = {
      inherit (cfg) user group;
      mode = "0700";
    };


    systemd.user.grafana-kiosk = {
...
"https://grafana.com/blog/2019/05/02/grafana-tutorial-how-to-create-kiosks-to-display-dashboards-on-a-tv"
    ...
    users.groups = mkIf (cfg.group == "grafana-kiosk") {
      grafana-kiosk = { };
    };
  };
}
